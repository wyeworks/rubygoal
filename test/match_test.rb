...
module Rubygoal
  class MatchTest < Minitest::Test
    ...
    def test_home_team_is_winning
      match = Match.create_for(:home, 100, 2, 0, {}, {})
    ...
    def test_home_team_is_losing
      match = Match.create_for(:home, 100, 1, 3, {}, {})
    ...
    def test_away_team_is_winning
      match = Match.create_for(:away, 100, 0, 2, {}, {})
    ...
    def test_away_team_is_losing
      match = Match.create_for(:away, 100, 3, 1, {}, {})
    ...
    def test_home_team_is_a_draw
      match = Match.create_for(:home, 100, 1, 1, {}, {})
    ...
    def test_away_team_is_a_draw
      match = Match.create_for(:away, 100, 1, 1, {}, {})
    ...
    def test_match_info_includes_player_positions
      ...
      match = Match.create_for(:away, 100, 1, 1, home_pos, away_pos)
