...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/coaches/opal_coach_definition"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$js_coach', '$map', '$to_sym', '$new', '$winning?', '$me', '$losing?', '$draw?', '$other', '$x', '$ball', '$y', '$defenders', '$to_proc', '$midfielders', '$attackers', '$private', '$raise']);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $OpalCoachDefinition(){};
      var self = $OpalCoachDefinition = $klass($base, $super, 'OpalCoachDefinition', $OpalCoachDefinition);
      ...
      Opal.defn(self, '$name', function() {
        ...
        return self.$js_coach().name();
      });

      Opal.defn(self, '$players', function() {
        var $a, $b, TMP_1, self = this;

        return ($a = ($b = self.$js_coach().players()).$map, $a.$$p = (TMP_1 = function(player){var self = TMP_1.$$s || this, name = nil, type = nil;
if (player == null) player = nil;
        name = player["name"].$to_sym();
          type = player["type"].$to_sym();
          return $scope.get('PlayerDefinition').$new(name, type);}, TMP_1.$$s = self, TMP_1), $a).call($b);
      });

      Opal.defn(self, '$formation', function(match) {
        var $a, $b, $c, $d, $e, $f, $g, self = this, result = nil, formation = nil;

        result = self.$js_coach().formation(
          {
            me: {
      ...
      return (Opal.defn(self, '$js_coach', function() {
        var self = this;

        return self.$raise("js_coach should be implemented by a subclass");
      }), nil) && 'js_coach';
...
Opal.modules["rubygoal/coaches/coach_definition_home"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$private']);
  self.$require("rubygoal/coach_definition");
  self.$require("rubygoal/coaches/opal_coach_definition");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$js_coach', function() {
        ...
        return WyeGoal.homeCoach;
      }), nil) && 'js_coach';
    })($scope.base, $scope.get('OpalCoachDefinition'))
  })($scope.base);
};
