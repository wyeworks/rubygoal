...
if (method == null) method = nil;
    ...
    Opal.defn(self, '$def_instance_delegators', function(accessor) {
      ...
      var methods = new Array(array_size);
      for($splat_index = 0; $splat_index < array_size; $splat_index++) {
        methods[$splat_index] = arguments[$splat_index + 1];
      }
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/util"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  ...
  Opal.add_stubs(['$*', '$cos', '$/', '$sin', '$hypot', '$-', '$atan2', '$angle', '$<', '$+', '$y', '$x', '$new']);
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base) {
      ...
      (function(self) {
        ...
        Opal.defn(self, '$offset_x', function(angle, distance) {
          var self = this;

          return $rb_times(distance, $scope.get('Math').$cos($rb_divide($rb_times(angle, (($scope.get('Math')).$$scope.get('PI'))), 180.0)));
        });
        Opal.defn(self, '$offset_y', function(angle, distance) {
          var self = this;

          return $rb_times(distance, $scope.get('Math').$sin($rb_divide($rb_times(angle, (($scope.get('Math')).$$scope.get('PI'))), 180.0)));
        });
        Opal.defn(self, '$distance', function(x1, y1, x2, y2) {
          var self = this;

          return $scope.get('Math').$hypot($rb_minus(x2, x1), $rb_minus(y2, y1));
        });
        Opal.defn(self, '$angle', function(x1, y1, x2, y2) {
          var self = this;

          return $rb_times($rb_divide($scope.get('Math').$atan2($rb_minus(y2, y1), $rb_minus(x2, x1)), (($scope.get('Math')).$$scope.get('PI'))), 180.0);
        });
        Opal.defn(self, '$positive_angle', function(x1, y1, x2, y2) {
          var $a, self = this, angle = nil;

          angle = self.$angle(x1, y1, x2, y2);
          if ((($a = $rb_lt(angle, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
            return $rb_plus(360, angle)
            } else {
            return angle
          };
        });
        return (Opal.defn(self, '$y_intercept_with_line', function(x, pos1, pos2) {
          var self = this, slope = nil;

          slope = $rb_divide(($rb_minus(pos2.$y(), pos1.$y())), ($rb_minus(pos2.$x(), pos1.$x())));
          return $scope.get('Position').$new(x, $rb_plus($rb_times(slope, ($rb_minus(x, pos1.$x()))), pos1.$y()));
        }), nil) && 'y_intercept_with_line';
      })(Opal.get_singleton_class(self))
    })($scope.base)
  })($scope.base)
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/coordinate"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$distance', '$x', '$y', '$new', '$class', '$+', '$*', '$!=']);
  self.$require("rubygoal/util");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $Coordinate(){};
      var self = $Coordinate = $klass($base, $super, 'Coordinate', $Coordinate);

      var def = self.$$proto, $scope = self.$$scope;

      Opal.defn(self, '$distance', function(coordinate) {
        var self = this;

        return $scope.get('Util').$distance(self.$x(), self.$y(), coordinate.$x(), coordinate.$y());
      });

      Opal.defn(self, '$add', function(coordinate) {
        var self = this;

        return self.$class().$new($rb_plus(self.$x(), coordinate.$x()), $rb_plus(self.$y(), coordinate.$y()));
      });

      Opal.defn(self, '$mult', function(coeficient) {
        var self = this;

        return self.$class().$new($rb_times(self.$x(), coeficient), $rb_times(self.$y(), coeficient));
      });
      ...
      return (Opal.defn(self, '$to_hash', function() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      return nil;
    })($scope.base, $scope.get('Coordinate'));

    (function($base, $super) {
      function $Velocity(){};
      var self = $Velocity = $klass($base, $super, 'Velocity', $Velocity);

      var def = self.$$proto, $scope = self.$$scope;

      return (Opal.defn(self, '$nonzero?', function() {
        var $a, self = this;

        return ((($a = self.$x()['$!='](0)) !== false && $a !== nil) ? $a : self.$y()['$!='](0));
      }), nil) && 'nonzero?'
    })($scope.base, $scope.get('Coordinate'));
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/moveable"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  ...
  Opal.add_stubs(['$require', '$attr_accessor', '$new', '$nonzero?', '$velocity', '$distance', '$x', '$position', '$y', '$destination=', '$rotation=', '$angle', '$x=', '$offset_x', '$rotation', '$speed', '$y=', '$offset_y', '$moving?', '$destination', '$<', '$stop', '$reset_rotation', '$position=', '$position_after_update', '$velocity=', '$/', '$mult', '$add', '$private', '$attr_reader']);
  self.$require("rubygoal/util");
  self.$require("rubygoal/coordinate");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base) {
      var $Moveable, self = $Moveable = $module($base, 'Moveable');

      var def = self.$$proto, $scope = self.$$scope;

      Opal.cdecl($scope, 'MIN_DISTANCE', 10);

      self.$attr_accessor("position", "velocity", "rotation");

      Opal.defn(self, '$initialize', function() {
        var self = this;

        self.position = $scope.get('Position').$new(0, 0);
        self.velocity = $scope.get('Velocity').$new(0, 0);
        self.speed = 0;
        self.destination = nil;
        return self.rotation = 0;
      });

      Opal.defn(self, '$moving?', function() {
        var self = this;

        return self.$velocity()['$nonzero?']();
      });

      Opal.defn(self, '$distance', function(position) {
        var self = this;

        return $scope.get('Util').$distance(self.$position().$x(), self.$position().$y(), position.$x(), position.$y());
      });

      Opal.defn(self, '$move_to', function(destination) {
        var $a, $b, self = this;

        (($a = [destination]), $b = self, $b['$destination='].apply($b, $a), $a[$a.length-1]);
        (($a = [$scope.get('Util').$angle(self.$position().$x(), self.$position().$y(), destination.$x(), destination.$y())]), $b = self, $b['$rotation='].apply($b, $a), $a[$a.length-1]);
        (($a = [$scope.get('Util').$offset_x(self.$rotation(), self.$speed())]), $b = self.$velocity(), $b['$x='].apply($b, $a), $a[$a.length-1]);
        return (($a = [$scope.get('Util').$offset_y(self.$rotation(), self.$speed())]), $b = self.$velocity(), $b['$y='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$update', function(elapsed_time) {
        var $a, $b, self = this;

        if ((($a = self['$moving?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          return nil
        };
        if ((($a = ($b = self.$destination(), $b !== false && $b !== nil ?$rb_lt(self.$distance(self.$destination()), $scope.get('MIN_DISTANCE')) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$stop();
          return self.$reset_rotation();
          } else {
          return (($a = [self.$position_after_update(elapsed_time)]), $b = self, $b['$position='].apply($b, $a), $a[$a.length-1])
        };
      });
      ...
      Opal.defn(self, '$stop', function() {
        ...
        (($a = [nil]), $b = self, $b['$destination='].apply($b, $a), $a[$a.length-1]);
        return (($a = [$scope.get('Velocity').$new(0, 0)]), $b = self, $b['$velocity='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$position_after_update', function(elapsed_time) {
        var self = this, custom_frame_rate = nil, coef = nil, movement = nil;

        custom_frame_rate = $rb_divide(1, 60.0);
        coef = $rb_divide(elapsed_time, custom_frame_rate);
        movement = self.$velocity().$mult(coef);
        return self.$position().$add(movement);
      });

      self.$private();

      self.$attr_reader("speed");

      self.$attr_accessor("destination");

      Opal.defn(self, '$reset_rotation', function() {
        var $a, $b, self = this;

        return (($a = [0]), $b = self, $b['$rotation='].apply($b, $a), $a[$a.length-1]);
      });
    })($scope.base)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/ball"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  ...
  Opal.add_stubs(['$require', '$include', '$reinitialize_position', '$goal?', '$position', '$velocity=', '$new', '$offset_x', '$offset_y', '$position=', '$center_position', '$prevent_out_of_bounds', '$decelerate', '$private', '$out_of_bounds_width?', '$velocity', '$x=', '$*', '$x', '$out_of_bounds_height?', '$y=', '$y', '$deceleration_coef', '$mult', '$/', '$**', '$configuration']);
  self.$require("rubygoal/util");
  self.$require("rubygoal/field");
  self.$require("rubygoal/moveable");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      self.$include($scope.get('Moveable'));
      ...
      Opal.defn(self, '$initialize', TMP_1 = function() {
        ...
        return self.$reinitialize_position();
      });

      Opal.defn(self, '$goal?', function() {
        var self = this;

        return $scope.get('Field')['$goal?'](self.$position());
      });

      Opal.defn(self, '$move', function(direction, speed) {
        var $a, $b, self = this;

        return (($a = [$scope.get('Velocity').$new($scope.get('Util').$offset_x(direction, speed), $scope.get('Util').$offset_y(direction, speed))]), $b = self, $b['$velocity='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$reinitialize_position', function() {
        var $a, $b, self = this;

        return (($a = [$scope.get('Field').$center_position()]), $b = self, $b['$position='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$update', TMP_2 = function(elapsed_time) {
        var self = this, $iter = TMP_2.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil;
        ...
        return self.$decelerate(elapsed_time);
      });

      self.$private();

      Opal.defn(self, '$prevent_out_of_bounds', function() {
        var $a, self = this;

        if ((($a = $scope.get('Field')['$out_of_bounds_width?'](self.$position())) !== nil && (!$a.$$is_boolean || $a == true))) {
          ($a = self.$velocity(), $a['$x=']($rb_times($a.$x(), -1)))};
        if ((($a = $scope.get('Field')['$out_of_bounds_height?'](self.$position())) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ($a = self.$velocity(), $a['$y=']($rb_times($a.$y(), -1)))
          } else {
          return nil
        };
      });

      Opal.defn(self, '$decelerate', function(elapsed_time) {
        var $a, $b, self = this, coef = nil;

        coef = self.$deceleration_coef(elapsed_time);
        return (($a = [self.$velocity().$mult(coef)]), $b = self, $b['$velocity='].apply($b, $a), $a[$a.length-1]);
      });

      return (Opal.defn(self, '$deceleration_coef', function(elapsed_time) {
        var self = this, custom_frame_rate = nil, time_coef = nil;

        custom_frame_rate = $rb_divide(1, 60.0);
        time_coef = $rb_divide(elapsed_time, custom_frame_rate);
        return $scope.get('Rubygoal').$configuration().$deceleration_coef()['$**'](time_coef);
      }), nil) && 'deceleration_coef';
    })($scope.base, null)
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/coach"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$extend', '$def_delegators', '$tap', '$check_unique_captain', '$check_players_count', '$empty?', '$errors', '$select', '$==', '$type', '$players', '$first', '$players_by_type', '$map', '$to_proc', '$average_players', '$fast_players', '$name', '$captain_player', '$new', '$lineup', '$defenders', '$[]', '$midfielders', '$attackers', '$private', '$attr_reader', '$configuration', '$size', '$!=', '$<<', '$send', '$game_config']);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $Coach(){};
      var self = $Coach = $klass($base, $super, 'Coach', $Coach);

      var def = self.$$proto, $scope = self.$$scope;

      self.$extend($scope.get('Forwardable'));

      self.$def_delegators("coach_definition", "players", "name", "formation");

      Opal.defn(self, '$initialize', function(coach_definition) {
        var self = this;

        return self.coach_definition = coach_definition;
      });

      Opal.defn(self, '$errors', function() {
        var $a, $b, TMP_1, self = this;

        return ($a = ($b = []).$tap, $a.$$p = (TMP_1 = function(errors){var self = TMP_1.$$s || this;
if (errors == null) errors = nil;
        self.$check_unique_captain(errors);
          self.$check_players_count("average", errors);
          return self.$check_players_count("fast", errors);}, TMP_1.$$s = self, TMP_1), $a).call($b);
      });

      Opal.defn(self, '$valid?', function() {
        var self = this;

        return self.$errors()['$empty?']();
      });

      Opal.defn(self, '$players_by_type', function(type) {
        var $a, $b, TMP_2, self = this;

        return ($a = ($b = self.$players()).$select, $a.$$p = (TMP_2 = function(p){var self = TMP_2.$$s || this;
if (p == null) p = nil;
        return p.$type()['$=='](type)}, TMP_2.$$s = self, TMP_2), $a).call($b);
      });

      Opal.defn(self, '$captain_player', function() {
        var self = this;

        return self.$players_by_type("captain").$first();
      });

      Opal.defn(self, '$fast_players', function() {
        var self = this;

        return self.$players_by_type("fast");
      });

      Opal.defn(self, '$average_players', function() {
        var self = this;

        return self.$players_by_type("average");
      });

      Opal.defn(self, '$initial_formation', function() {
        var $a, $b, $c, $d, TMP_3, self = this, average_names = nil, fast_names = nil, captain_name = nil, formation = nil;

        average_names = ($a = ($b = self.$average_players()).$map, $a.$$p = "name".$to_proc(), $a).call($b);
        fast_names = ($a = ($c = self.$fast_players()).$map, $a.$$p = "name".$to_proc(), $a).call($c);
        captain_name = self.$captain_player().$name();
        formation = $scope.get('Formation').$new();
        ($a = ($d = formation).$lineup, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        self.$defenders(average_names['$[]'](0), average_names['$[]'](2), "none", average_names['$[]'](3), average_names['$[]'](4));
          self.$midfielders(average_names['$[]'](1), fast_names['$[]'](0), "none", fast_names['$[]'](1), average_names['$[]'](5));
          return self.$attackers("none", captain_name, "none", fast_names['$[]'](2), "none");}, TMP_3.$$s = self, TMP_3), $a).call($d);
        return formation;
      });

      self.$private();

      self.$attr_reader("coach_definition");

      Opal.defn(self, '$game_config', function() {
        var self = this;

        return $scope.get('Rubygoal').$configuration();
      });

      Opal.defn(self, '$check_unique_captain', function(errors) {
        var $a, self = this, captain_count = nil;

        captain_count = self.$players_by_type("captain").$size();
        if ((($a = captain_count['$!='](1)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return errors['$<<']("The number of captains is " + (captain_count))
          } else {
          return nil
        };
      });

      return (Opal.defn(self, '$check_players_count', function(type, errors) {
        var $a, self = this, players_count = nil;

        players_count = self.$players_by_type(type).$size();
        if ((($a = players_count['$!='](self.$game_config().$send("" + (type) + "_players_count"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return errors['$<<']("The number of " + (type) + " players is " + (players_count))
          } else {
          return nil
        };
      }), nil) && 'check_players_count';
    })($scope.base, null)
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/coach_definition"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$new', '$attr_reader', '$instance_eval', '$to_proc', '$to_sym', '$first', '$<<', '$team_players', '$class', '$team_name', '$raise']);
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $CoachDefinition(){};
      var self = $CoachDefinition = $klass($base, $super, 'CoachDefinition', $CoachDefinition);

      var def = self.$$proto, $scope = self.$$scope;

      Opal.cdecl($scope, 'PlayerDefinition', $scope.get('Struct').$new("name", "type"));

      (function(self) {
        var $scope = self.$$scope, def = self.$$proto, TMP_1, TMP_2;

        self.$attr_reader("team_name");
        Opal.defn(self, '$team', TMP_1 = function() {
          var $a, $b, self = this, $iter = TMP_1.$$p, block = $iter || nil;

          TMP_1.$$p = null;
          return ($a = ($b = self).$instance_eval, $a.$$p = block.$to_proc(), $a).call($b);
        });
        Opal.defn(self, '$name', function(team_name) {
          var self = this;

          return self.team_name = team_name;
        });
        Opal.defn(self, '$players', TMP_2 = function() {
          var $a, $b, self = this, $iter = TMP_2.$$p, block = $iter || nil;
        ...
        Opal.defn(self, '$method_missing', function(method) {
          var self = this, name = nil, $splat_index = nil;
          if (self.team_players == null) self.team_players = nil;
          ...
          return self.team_players['$<<']($scope.get('PlayerDefinition').$new(name, method.$to_sym()));
        });
        return (Opal.defn(self, '$team_players', function() {
          var $a, self = this;
          if (self.team_players == null) self.team_players = nil;

          return ((($a = self.team_players) !== false && $a !== nil) ? $a : [$scope.get('PlayerDefinition').$new("captain", "captain"), $scope.get('PlayerDefinition').$new("fast1", "fast"), $scope.get('PlayerDefinition').$new("fast2", "fast"), $scope.get('PlayerDefinition').$new("fast3", "fast"), $scope.get('PlayerDefinition').$new("average1", "average"), $scope.get('PlayerDefinition').$new("average2", "average"), $scope.get('PlayerDefinition').$new("average3", "average"), $scope.get('PlayerDefinition').$new("average4", "average"), $scope.get('PlayerDefinition').$new("average5", "average"), $scope.get('PlayerDefinition').$new("average6", "average")]);
        }), nil) && 'team_players';
      })(Opal.get_singleton_class(self));

      Opal.defn(self, '$players', function() {
        var self = this;

        return self.$class().$team_players();
      });

      Opal.defn(self, '$name', function() {
        var self = this;

        return self.$class().$team_name();
      });

      return (Opal.defn(self, '$formation', function(match) {
        var self = this;
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/formation/formation_dsl"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  ...
  Opal.add_stubs(['$new', '$instance_eval', '$to_proc', '$apply', '$private', '$merge!', '$lines_definition', '$formation', '$lines', '$attr_reader', '$define_line', '$first', '$[]=', '$*', '$/', '$players_position', '$player_name', '$player_position', '$attr_accessor', '$player_name=', '$player_position=', '$position_from_percentages']);
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $Formation(){};
      var self = $Formation = $klass($base, $super, 'Formation', $Formation);

      var def = self.$$proto, $scope = self.$$scope;

      (function($base, $super) {
        function $FormationDSL(){};
        var self = $FormationDSL = $klass($base, $super, 'FormationDSL', $FormationDSL);

        var def = self.$$proto, $scope = self.$$scope, TMP_1;

        Opal.defs(self, '$apply', TMP_1 = function(formation) {
          var $a, $b, self = this, $iter = TMP_1.$$p, block = $iter || nil, dsl = nil;

          TMP_1.$$p = null;
          dsl = self.$new(formation);
          ($a = ($b = dsl).$instance_eval, $a.$$p = block.$to_proc(), $a).call($b);
          return dsl.$apply();
        });

        self.$private();

        Opal.defn(self, '$field_width', function() {
          var self = this;

          return 100.0;
        });

        return (Opal.defn(self, '$field_height', function() {
          var self = this;
      ...
      (function($base, $super) {
        ...
        var self = $CustomLines = $klass($base, $super, 'CustomLines', $CustomLines);

        var def = self.$$proto, $scope = self.$$scope;

        Opal.defn(self, '$initialize', function(formation) {
          var self = this;

          self.formation = formation;
          return self.lines = $hash2([], {});
        });

        Opal.defn(self, '$apply', function() {
          var self = this;

          return self.$formation().$lines_definition()['$merge!'](self.$lines());
        });

        self.$private();

        self.$attr_reader("formation", "lines");
        ...
        Opal.defn(self, '$method_missing', function(method) {
          ...
          return self.$define_line(method, args.$first());
        });

        return (Opal.defn(self, '$define_line', function(name, x_position) {
          var self = this;

          return self.$lines()['$[]='](name, $rb_times($rb_divide(x_position, 100.0), (($scope.get('Field')).$$scope.get('WIDTH'))));
        }), nil) && 'define_line';
      })($scope.base, $scope.get('FormationDSL'));

      return (function($base, $super) {
        function $CustomPosition(){};
        var self = $CustomPosition = $klass($base, $super, 'CustomPosition', $CustomPosition);
        ...
        Opal.defn(self, '$initialize', function(formation) {
          ...
          return self.formation = formation;
        });

        Opal.defn(self, '$apply', function() {
          var self = this;

          return self.$formation().$players_position()['$[]='](self.$player_name(), self.$player_position());
        });

        self.$private();

        self.$attr_reader("formation");

        self.$attr_accessor("player_name", "player_position");

        Opal.defn(self, '$player', function(name) {
          var $a, $b, self = this;

          return (($a = [name]), $b = self, $b['$player_name='].apply($b, $a), $a[$a.length-1]);
        });

        return (Opal.defn(self, '$position', function(x, y) {
          var $a, $b, self = this;

          return (($a = [$scope.get('Field').$position_from_percentages($scope.get('Position').$new(x, y))]), $b = self, $b['$player_position='].apply($b, $a), $a[$a.length-1]);
        }), nil) && 'position';
      })($scope.base, $scope.get('FormationDSL'));
    })($scope.base, null)
  })($scope.base)
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/formation"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_divide(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs / rhs : lhs['$/'](rhs);
  ...
  Opal.add_stubs(['$require', '$attr_accessor', '$/', '$*', '$to_sym', '$chomp', '$to_s', '$[]', '$lines_definition', '$set_players_in_custom_line', '$instance_eval', '$to_proc', '$!=', '$size', '$players_position', '$<<', '$empty?', '$errors', '$private', '$apply', '$new', '$line_position_separation', '$each_with_index', '$==', '$+', '$add', '$[]=']);
  self.$require("rubygoal/formation/formation_dsl");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      self.$attr_accessor("players_position", "lines_definition");

      Opal.defn(self, '$initialize', function() {
        var self = this;

        self.players_position = $hash2([], {});
        return self.lines_definition = $hash2(["defenders", "def_midfielders", "midfielders", "att_midfielders", "attackers"], {"defenders": $rb_divide((($scope.get('Field')).$$scope.get('WIDTH')), 6), "def_midfielders": $rb_divide((($scope.get('Field')).$$scope.get('WIDTH')), 3), "midfielders": $rb_divide((($scope.get('Field')).$$scope.get('WIDTH')), 2), "att_midfielders": $rb_times($rb_divide((($scope.get('Field')).$$scope.get('WIDTH')), 3), 2), "attackers": $rb_times($rb_divide((($scope.get('Field')).$$scope.get('WIDTH')), 6), 5)});
      });

      Opal.defn(self, '$method_missing', function(method) {
        var $a, self = this, line_name = nil, $splat_index = nil;
        ...
        if ((($a = self.$lines_definition()['$[]'](line_name)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.$set_players_in_custom_line(self.$lines_definition()['$[]'](line_name), args)
          } else {
          return nil
        };
      });

      Opal.defn(self, '$lineup', TMP_1 = function() {
        var $a, $b, self = this, $iter = TMP_1.$$p, block = $iter || nil;
      ...
      Opal.defn(self, '$errors', function() {
        ...
        errors = [];
        if ((($a = self.$players_position().$size()['$!='](10)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$lines', TMP_2 = function() {
        var $a, $b, self = this, $iter = TMP_2.$$p, block = $iter || nil;

        TMP_2.$$p = null;
        return ($a = ($b = $scope.get('CustomLines')).$apply, $a.$$p = block.$to_proc(), $a).call($b, self);
      });

      Opal.defn(self, '$custom_position', TMP_3 = function() {
        var $a, $b, self = this, $iter = TMP_3.$$p, block = $iter || nil;

        TMP_3.$$p = null;
        return ($a = ($b = $scope.get('CustomPosition')).$apply, $a.$$p = block.$to_proc(), $a).call($b, self);
      });

      Opal.defn(self, '$set_players_in_custom_line', function(position_x, players) {
        var $a, $b, TMP_4, self = this, base_position = nil, separation = nil;

        base_position = $scope.get('Position').$new(position_x, 0);
        separation = self.$line_position_separation(players);
        return ($a = ($b = players).$each_with_index, $a.$$p = (TMP_4 = function(player, i){var self = TMP_4.$$s || this, offset = nil, position = nil;
if (player == null) player = nil;if (i == null) i = nil;
        if (player['$==']("none")) {
            return nil;};
          offset = $scope.get('Position').$new(0, $rb_times(separation, ($rb_plus(i, 1))));
          position = base_position.$add(offset);
          return self.$players_position()['$[]='](player, position);}, TMP_4.$$s = self, TMP_4), $a).call($b);
      });

      return (Opal.defn(self, '$line_position_separation', function(players) {
        var self = this;

        return $rb_divide((($scope.get('Field')).$$scope.get('HEIGHT')), ($rb_plus(players.$size(), 1)));
      }), nil) && 'line_position_separation';
    })($scope.base, null)
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/coaches/coach_definition_home"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$team', '$name', '$players', '$times', '$to_sym', '$===', '$captain', '$fast', '$average', '$winning?', '$me', '$losing?', '$draw?', '$other', '$x', '$ball', '$y', '$new', '$defenders', '$map', '$to_proc', '$midfielders', '$attackers']);
  self.$require("rubygoal/coach_definition");
  self.$require("rubygoal/formation");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $CoachDefinitionHome(){};
      var self = $CoachDefinitionHome = $klass($base, $super, 'CoachDefinitionHome', $CoachDefinitionHome);

      var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

      ($a = ($b = self).$team, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, $b, TMP_2;

      self.$name(JSGoal.HomeCoachDefinition.name);
        return ($a = ($b = self).$players, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $a, $b, TMP_3;

        return ($a = ($b = (10)).$times, $a.$$p = (TMP_3 = function(i){var self = TMP_3.$$s || this, player_name = nil, $case = nil;
if (i == null) i = nil;
          player_name = (JSGoal.HomeCoachDefinition.players[i].name).$to_sym();
            return (function() {$case = JSGoal.HomeCoachDefinition.players[i].type;if ("captain"['$===']($case)) {return self.$captain(player_name)}else if ("fast"['$===']($case)) {return self.$fast(player_name)}else if ("average"['$===']($case)) {return self.$average(player_name)}else { return nil }})();}, TMP_3.$$s = self, TMP_3), $a).call($b)}, TMP_2.$$s = self, TMP_2), $a).call($b);}, TMP_1.$$s = self, TMP_1), $a).call($b);

      Opal.defn(self, '$formation', function(match) {
        var $a, $b, $c, $d, $e, $f, $g, self = this, result = nil, formation = nil;
      ...
      ;
        formation = $scope.get('Formation').$new();
        ($a = formation).$defenders.apply($a, Opal.to_a((($b = ($c = result["defenders"]).$map, $b.$$p = "to_sym".$to_proc(), $b).call($c))));
        ($b = formation).$midfielders.apply($b, Opal.to_a((($d = ($e = result["midfielders"]).$map, $d.$$p = "to_sym".$to_proc(), $d).call($e))));
        ($d = formation).$attackers.apply($d, Opal.to_a((($f = ($g = result["attackers"]).$map, $f.$$p = "to_sym".$to_proc(), $f).call($g))));
        return formation;
      });

      return (Opal.defn(self, '$formation_original', function(match) {
        var self = this, formation = nil;
        ...
        return formation;
      }), nil) && 'formation_original';
    })($scope.base, $scope.get('CoachDefinition'))
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/coaches/coach_definition_away"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$team', '$name', '$new', '$winning?', '$me', '$lineup', '$defenders', '$midfielders', '$att_midfielders', '$attackers', '$def_midfielders']);
  self.$require("rubygoal/coach_definition");
  self.$require("rubygoal/formation");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $CoachDefinitionAway(){};
      var self = $CoachDefinitionAway = $klass($base, $super, 'CoachDefinitionAway', $CoachDefinitionAway);

      var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

      ($a = ($b = self).$team, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

      return self.$name("Brasil")}, TMP_1.$$s = self, TMP_1), $a).call($b);

      return (Opal.defn(self, '$formation', function(match) {
        var $a, $b, TMP_2, $c, TMP_3, self = this, formation = nil;

        formation = $scope.get('Formation').$new();
        if ((($a = match.$me()['$winning?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ($a = ($b = formation).$lineup, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

          self.$defenders("average1", "fast1", "none", "fast3", "average5");
            self.$midfielders("average2", "none", "captain", "none", "average6");
            self.$att_midfielders("average3");
            return self.$attackers("none", "none", "fast2", "average4", "none");}, TMP_2.$$s = self, TMP_2), $a).call($b)
          } else {
          ($a = ($c = formation).$lineup, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

          self.$defenders("none", "average2", "fast1", "average5", "none");
            self.$def_midfielders("average4");
            self.$midfielders("average1", "none", "none", "captain", "average6");
            self.$att_midfielders("fast2");
            return self.$attackers("none", "average3", "none", "fast3", "none");}, TMP_3.$$s = self, TMP_3), $a).call($c)
        };
        return formation;
      }), nil) && 'formation';
    })($scope.base, $scope.get('CoachDefinition'))
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/coach_loader"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  ...
  Opal.add_stubs(['$require', '$new', '$load_definition_coach', '$private', '$attr_reader', '$[]', '$side', '$filename', '$exists?', '$load', '$camelize', '$basename', '$const_get', '$debug_output', '$configuration', '$puts', '$name', '$default_definition_class', '$==', '$to_s', '$sub', '$capitalize', '$gsub!']);
  self.$require("rubygoal/coach");
  self.$require("rubygoal/coaches/coach_definition_home");
  self.$require("rubygoal/coaches/coach_definition_away");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      var self = $CoachLoader = $klass($base, $super, 'CoachLoader', $CoachLoader);

      var def = self.$$proto, $scope = self.$$scope;

      Opal.cdecl($scope, 'DEFAULT_COACH_DEFINITIONS', $hash2(["home", "away"], {"home": $scope.get('CoachDefinitionHome'), "away": $scope.get('CoachDefinitionAway')}));

      Opal.defn(self, '$initialize', function(side) {
        var self = this;

        return self.side = side;
      });

      Opal.defn(self, '$coach', function() {
        var self = this;

        return $scope.get('Coach').$new(self.$load_definition_coach());
      });

      self.$private();

      self.$attr_reader("side");

      Opal.defn(self, '$default_definition_class', function() {
        var self = this;

        return $scope.get('DEFAULT_COACH_DEFINITIONS')['$[]'](self.$side());
      });

      Opal.defn(self, '$load_definition_coach', function() {
        var $a, $b, self = this, class_name = nil;

        if ((($a = ($b = self.$filename(), $b !== false && $b !== nil ?$scope.get('File')['$exists?'](self.$filename()) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$load(self.$filename());
          class_name = self.$camelize($scope.get('File').$basename(self.$filename(), ".rb"));
          return $scope.get('Rubygoal').$const_get(class_name).$new();
          } else {
          if ((($a = ($b = self.$filename(), $b !== false && $b !== nil ?$scope.get('Rubygoal').$configuration().$debug_output() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            self.$puts("File `" + (self.$filename()) + "` doesn't exist. Using " + (self.$default_definition_class().$name()) + ".")};
          return self.$default_definition_class().$new();
        };
      });

      Opal.defn(self, '$filename', function() {
        var self = this;

        if (self.$side()['$==']("home")) {
          return $scope.get('ARGV')['$[]'](0)
          } else {
          return $scope.get('ARGV')['$[]'](1)
        };
      });

      return (Opal.defn(self, '$camelize', function(term) {
        var $a, $b, TMP_1, $c, TMP_2, self = this, string = nil;

        string = term.$to_s();
        string = ($a = ($b = string).$sub, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a;

        return (($a = $gvars['~']) === nil ? nil : $a['$[]'](0)).$capitalize()}, TMP_1.$$s = self, TMP_1), $a).call($b, /^[a-z\d]*/);
        ($a = ($c = string)['$gsub!'], $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $a;

        return "" + ((($a = $gvars['~']) === nil ? nil : $a['$[]'](1))) + ((($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$capitalize())}, TMP_2.$$s = self, TMP_2), $a).call($c, /(?:_|(\/))([a-z\d]*)/i);
        string['$gsub!']("/", "::");
        return string;
      }), nil) && 'camelize';
    })($scope.base, null)
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/configuration"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$attr_accessor', '$attr_writer', '$new', '$configuration', '$configure', '$average_players_count=', '$fast_players_count=', '$kick_strength=', '$kick_again_delay=', '$distance_control_ball=', '$deceleration_coef=', '$average_lower_error=', '$average_upper_error=', '$average_speed=', '$fast_lower_error=', '$fast_upper_error=', '$fast_speed=', '$captain_error=', '$captain_speed=', '$game_time=', '$debug_output=', '$record_game=']);
  self.$require("rubygoal/coordinate");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      return self.$attr_accessor("average_players_count", "fast_players_count", "captain_players_count", "kick_strength", "kick_again_delay", "distance_control_ball", "deceleration_coef", "initial_player_positions", "game_time", "average_lower_error", "average_upper_error", "average_speed", "fast_lower_error", "fast_upper_error", "fast_speed", "captain_error", "captain_speed", "debug_output", "record_game")
    })($scope.base, null);

    (function(self) {
      var $scope = self.$$scope, def = self.$$proto, TMP_1;

      self.$attr_writer("configuration");
      Opal.defn(self, '$configuration', function() {
        var $a, self = this;
      ...
      return (Opal.defn(self, '$configure', TMP_1 = function() {
    ...
    ($a = ($b = $scope.get('Rubygoal')).$configure, $a.$$p = (TMP_2 = function(config){var self = TMP_2.$$s || this, $a, $b;
if (config == null) config = nil;
    (($a = [6]), $b = config, $b['$average_players_count='].apply($b, $a), $a[$a.length-1]);
      (($a = [3]), $b = config, $b['$fast_players_count='].apply($b, $a), $a[$a.length-1]);
      (($a = [20]), $b = config, $b['$kick_strength='].apply($b, $a), $a[$a.length-1]);
      (($a = [1]), $b = config, $b['$kick_again_delay='].apply($b, $a), $a[$a.length-1]);
      (($a = [30]), $b = config, $b['$distance_control_ball='].apply($b, $a), $a[$a.length-1]);
      (($a = [0.95]), $b = config, $b['$deceleration_coef='].apply($b, $a), $a[$a.length-1]);
      (($a = [0.1]), $b = config, $b['$average_lower_error='].apply($b, $a), $a[$a.length-1]);
      (($a = [0.15]), $b = config, $b['$average_upper_error='].apply($b, $a), $a[$a.length-1]);
      (($a = [3.5]), $b = config, $b['$average_speed='].apply($b, $a), $a[$a.length-1]);
      (($a = [0.1]), $b = config, $b['$fast_lower_error='].apply($b, $a), $a[$a.length-1]);
      (($a = [0.15]), $b = config, $b['$fast_upper_error='].apply($b, $a), $a[$a.length-1]);
      (($a = [4]), $b = config, $b['$fast_speed='].apply($b, $a), $a[$a.length-1]);
      (($a = [0.05]), $b = config, $b['$captain_error='].apply($b, $a), $a[$a.length-1]);
      (($a = [4.5]), $b = config, $b['$captain_speed='].apply($b, $a), $a[$a.length-1]);
      (($a = [120]), $b = config, $b['$game_time='].apply($b, $a), $a[$a.length-1]);
      (($a = [true]), $b = config, $b['$debug_output='].apply($b, $a), $a[$a.length-1]);
      return (($a = [false]), $b = config, $b['$record_game='].apply($b, $a), $a[$a.length-1]);}, TMP_2.$$s = self, TMP_2), $a).call($b);
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/players/player_movement"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  ...
  Opal.add_stubs(['$require', '$extend', '$def_delegators', '$elapsed_time=', '$blocking_player', '$close_to_destination?', '$any_moving_and_very_close_player?', '$stop', '$player', '$blocking_player_very_close?', '$adapt_velocity_when_very_close', '$blocking_player_close?', '$adapt_velocity_when_close', '$private', '$attr_reader', '$attr_accessor', '$-', '$players', '$game', '$select', '$>', '$distance', '$destination', '$position_after_update', '$position', '$game_players_except_me', '$min_by', '$game_players_closer_to_destination', '$<', '$any?', '$moving?', '$angle', '$x', '$velocity', '$y', '$velocity=', '$new', '$offset_x', '$offset_y', '$to_f', '$+', '$/', '$*', '$mult', '$elapsed_time']);
  self.$require("rubygoal/player");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      var self = $PlayerMovement = $klass($base, $super, 'PlayerMovement', $PlayerMovement);

      var def = self.$$proto, $scope = self.$$scope;

      Opal.cdecl($scope, 'PLAYERS_MIN_DISTANCE', 50);

      Opal.cdecl($scope, 'CLOSE_TO_DESTINATION', 60);

      Opal.cdecl($scope, 'PLAYERS_CLOSE_DISTANCE', 70);

      self.$extend($scope.get('Forwardable'));

      self.$def_delegators("player", "position", "velocity", "destination");

      Opal.defn(self, '$initialize', function(game, player) {
        var self = this;
      ...
      Opal.defn(self, '$update', function(elapsed_time) {
        ...
        (($a = [elapsed_time]), $b = self, $b['$elapsed_time='].apply($b, $a), $a[$a.length-1]);
        if ((($a = self.$blocking_player()) !== nil && (!$a.$$is_boolean || $a == true))) {
          if ((($a = ((($b = self['$close_to_destination?']()) !== false && $b !== nil) ? $b : self['$any_moving_and_very_close_player?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
            return self.$player().$stop()
          } else if ((($a = self['$blocking_player_very_close?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return self.$adapt_velocity_when_very_close()
          } else if ((($a = self['$blocking_player_close?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return self.$adapt_velocity_when_close()
            } else {
            return nil
          }
          } else {
      ...
      self.$attr_reader("game", "player");

      self.$attr_accessor("elapsed_time");

      Opal.defn(self, '$game_players_except_me', function() {
        var self = this;

        return $rb_minus(self.$game().$players(), [self.$player()]);
      });

      Opal.defn(self, '$game_players_closer_to_destination', function() {
        var $a, $b, TMP_1, self = this;

        return ($a = ($b = self.$game_players_except_me()).$select, $a.$$p = (TMP_1 = function(p){var self = TMP_1.$$s || this;
if (p == null) p = nil;
        return $rb_gt(self.$destination().$distance(self.$position_after_update()), self.$destination().$distance(p.$position()))}, TMP_1.$$s = self, TMP_1), $a).call($b);
      });

      Opal.defn(self, '$blocking_player', function() {
        var $a, $b, TMP_2, self = this;

        return ($a = ($b = self.$game_players_closer_to_destination()).$min_by, $a.$$p = (TMP_2 = function(p){var self = TMP_2.$$s || this;
if (p == null) p = nil;
        return self.$position_after_update().$distance(p.$position())}, TMP_2.$$s = self, TMP_2), $a).call($b);
      });

      Opal.defn(self, '$close_to_destination?', function() {
        var self = this;

        return $rb_lt(self.$position_after_update().$distance(self.$destination()), $scope.get('CLOSE_TO_DESTINATION'));
      });

      Opal.defn(self, '$blocking_player_very_close?', function() {
        var self = this;

        return $rb_lt(self.$blocking_player().$distance(self.$position()), $scope.get('PLAYERS_MIN_DISTANCE'));
      });

      Opal.defn(self, '$blocking_player_close?', function() {
        var self = this;

        return $rb_lt(self.$blocking_player().$distance(self.$position()), $scope.get('PLAYERS_CLOSE_DISTANCE'));
      });

      Opal.defn(self, '$any_moving_and_very_close_player?', function() {
        var $a, $b, TMP_3, self = this;

        return ($a = ($b = self.$game_players_closer_to_destination())['$any?'], $a.$$p = (TMP_3 = function(p){var self = TMP_3.$$s || this, $a;
if (p == null) p = nil;
        return ($a = p['$moving?'](), $a !== false && $a !== nil ?$rb_lt(p.$distance(self.$position_after_update()), $scope.get('PLAYERS_MIN_DISTANCE')) : $a)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      });

      Opal.defn(self, '$adapt_velocity_when_very_close', function() {
        var $a, $b, self = this, vel_angle = nil, vel_magnitude = nil;

        vel_angle = $rb_minus($scope.get('Util').$angle(0, 0, self.$velocity().$x(), self.$velocity().$y()), 45);
        vel_magnitude = $scope.get('Util').$distance(0, 0, self.$velocity().$x(), self.$velocity().$y());
        return (($a = [$scope.get('Velocity').$new($scope.get('Util').$offset_x(vel_angle, vel_magnitude), $scope.get('Util').$offset_y(vel_angle, vel_magnitude))]), $b = self.$player(), $b['$velocity='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$adapt_velocity_when_close', function() {
        var $a, $b, self = this, distance_to_run = nil, close_range_distance = nil, deceleration_coef = nil;

        distance_to_run = $rb_minus(self.$blocking_player().$distance(self.$position_after_update()), $scope.get('PLAYERS_MIN_DISTANCE'));
        close_range_distance = ($rb_minus($scope.get('PLAYERS_CLOSE_DISTANCE'), $scope.get('PLAYERS_MIN_DISTANCE'))).$to_f();
        deceleration_coef = $rb_plus($rb_divide(($rb_times(distance_to_run, 0.5)), close_range_distance), 0.5);
        return (($a = [self.$velocity().$mult(deceleration_coef)]), $b = self.$player(), $b['$velocity='].apply($b, $a), $a[$a.length-1]);
      });

      return (Opal.defn(self, '$position_after_update', function() {
        var self = this;

        return self.$player().$position_after_update(self.$elapsed_time());
      }), nil) && 'position_after_update';
    })($scope.base, null)
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/player"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  ...
  Opal.add_stubs(['$require', '$include', '$attr_reader', '$attr_accessor', '$new', '$!', '$waiting_to_kick_again?', '$control_ball?', '$random_direction', '$random_strength', '$move', '$reset_waiting_to_kick!', '$move_to', '$coach_defined_position', '$update_waiting_to_kick', '$moving?', '$update', '$player_movement', '$protected', '$private', '$>', '$time_to_kick_again', '$time_to_kick_again=', '$kick_again_delay', '$configuration', '$-', '$<', '$distance', '$position', '$distance_control_ball', '$+', '$*', '$to_f', '$error', '$kick_strength', '$angle', '$x', '$y', '$-@']);
  self.$require("rubygoal/coordinate");
  self.$require("rubygoal/moveable");
  self.$require("rubygoal/configuration");
  self.$require("rubygoal/util");
  self.$require("rubygoal/players/player_movement");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      Opal.cdecl($scope, 'STRAIGHT_ANGLE', 180);

      self.$include($scope.get('Moveable'));

      self.$attr_reader("side", "type");

      self.$attr_accessor("coach_defined_position");

      Opal.defn(self, '$initialize', TMP_1 = function(game, side) {
        var self = this, $iter = TMP_1.$$p, $yield = $iter || nil;

        TMP_1.$$p = null;
        Opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, []);
        self.time_to_kick_again = 0;
        self.side = side;
        return self.player_movement = $scope.get('PlayerMovement').$new(game, self);
      });

      Opal.defn(self, '$can_kick?', function(ball) {
        var $a, self = this;

        return ($a = self['$waiting_to_kick_again?']()['$!'](), $a !== false && $a !== nil ?self['$control_ball?'](ball) : $a);
      });

      Opal.defn(self, '$kick', function(ball, target) {
        var self = this, direction = nil, strength = nil;

        direction = self.$random_direction(target);
        strength = self.$random_strength();
        ball.$move(direction, strength);
        return self['$reset_waiting_to_kick!']();
      });

      Opal.defn(self, '$move_to_coach_position', function() {
        var self = this;

        return self.$move_to(self.$coach_defined_position());
      });
      ...
      Opal.defn(self, '$update', TMP_2 = function(elapsed_time) {
        ...
        self.$update_waiting_to_kick(elapsed_time);
        if ((($a = self['$moving?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$player_movement().$update(elapsed_time)};
        return Opal.find_super_dispatcher(self, 'update', TMP_2, $iter).apply(self, $zuper);
      });

      self.$protected();

      self.$attr_accessor("time_to_kick_again", "player_movement");

      self.$private();

      self.$attr_reader("error");

      Opal.defn(self, '$waiting_to_kick_again?', function() {
        var self = this;

        return $rb_gt(self.$time_to_kick_again(), 0);
      });

      Opal.defn(self, '$reset_waiting_to_kick!', function() {
        var $a, $b, self = this;

        return (($a = [$scope.get('Rubygoal').$configuration().$kick_again_delay()]), $b = self, $b['$time_to_kick_again='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$update_waiting_to_kick', function(time_elapsed) {
        var $a, self = this;

        if ((($a = self['$waiting_to_kick_again?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ($a = self, $a['$time_to_kick_again=']($rb_minus($a.$time_to_kick_again(), time_elapsed)))
          } else {
          return nil
        };
      });

      Opal.defn(self, '$control_ball?', function(ball) {
        var self = this;

        return $rb_lt(self.$distance(ball.$position()), $scope.get('Rubygoal').$configuration().$distance_control_ball());
      });

      Opal.defn(self, '$random_strength', function() {
        var self = this, error_coef = nil;

        error_coef = $rb_minus($rb_plus($rb_times($rb_times((Math.random()).$to_f(), 2), self.$error()), 1), self.$error());
        return $rb_times($scope.get('Rubygoal').$configuration().$kick_strength(), error_coef);
      });

      return (Opal.defn(self, '$random_direction', function(target) {
        var self = this, direction = nil, max_angle_error = nil, angle_error_range = nil;

        direction = $scope.get('Util').$angle(self.$position().$x(), self.$position().$y(), target.$x(), target.$y());
        max_angle_error = $rb_times($scope.get('STRAIGHT_ANGLE'), self.$error());
        angle_error_range = $range(max_angle_error['$-@'](), max_angle_error, false);
        return direction = $rb_plus(direction, $rb_minus($rb_times($rb_times((Math.random()).$to_f(), 2), max_angle_error), max_angle_error));
      }), nil) && 'random_direction';
    })($scope.base, null)
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/players/average"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$configuration', '$average_lower_error', '$average_upper_error', '$+', '$*', '$to_f', '$-', '$average_speed']);
  self.$require("rubygoal/player");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $AveragePlayer(){};
      var self = $AveragePlayer = $klass($base, $super, 'AveragePlayer', $AveragePlayer);

      var def = self.$$proto, $scope = self.$$scope, TMP_1;

      return (Opal.defn(self, '$initialize', TMP_1 = function() {
        var self = this, $iter = TMP_1.$$p, $yield = $iter || nil, config = nil, error_range = nil, $splat_index = nil, $zuper = nil, $zuper_index = nil;
        ...
        Opal.find_super_dispatcher(self, 'initialize', TMP_1, $iter).apply(self, $zuper);
        config = $scope.get('Rubygoal').$configuration();
        error_range = $range(config.$average_lower_error(), config.$average_upper_error(), false);
        self.error = $rb_plus($rb_times((Math.random()).$to_f(), ($rb_minus(config.$average_upper_error(), config.$average_lower_error()))), config.$average_lower_error());
        self.speed = config.$average_speed();
        return self.type = "average";
      }), nil) && 'initialize'
    })($scope.base, $scope.get('Player'))
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/players/fast"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$configuration', '$fast_lower_error', '$fast_upper_error', '$+', '$*', '$to_f', '$-', '$fast_speed']);
  self.$require("rubygoal/player");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $FastPlayer(){};
      var self = $FastPlayer = $klass($base, $super, 'FastPlayer', $FastPlayer);
      ...
      return (Opal.defn(self, '$initialize', TMP_1 = function() {
        ...
        Opal.find_super_dispatcher(self, 'initialize', TMP_1, $iter).apply(self, $zuper);
        config = $scope.get('Rubygoal').$configuration();
        error_range = $range(config.$fast_lower_error(), config.$fast_upper_error(), false);
        self.error = $rb_plus($rb_times((Math.random()).$to_f(), ($rb_minus(config.$fast_upper_error(), config.$fast_lower_error()))), config.$fast_lower_error());
        self.speed = config.$fast_speed();
        return self.type = "fast";
      }), nil) && 'initialize'
    })($scope.base, $scope.get('Player'))
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/players/captain"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$configuration', '$captain_error', '$captain_speed']);
  self.$require("rubygoal/player");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $CaptainPlayer(){};
      var self = $CaptainPlayer = $klass($base, $super, 'CaptainPlayer', $CaptainPlayer);

      var def = self.$$proto, $scope = self.$$scope, TMP_1;

      return (Opal.defn(self, '$initialize', TMP_1 = function() {
        var self = this, $iter = TMP_1.$$p, $yield = $iter || nil, config = nil, $splat_index = nil, $zuper = nil, $zuper_index = nil;
        ...
        Opal.find_super_dispatcher(self, 'initialize', TMP_1, $iter).apply(self, $zuper);
        config = $scope.get('Rubygoal').$configuration();
        self.error = config.$captain_error();
        self.speed = config.$captain_speed();
        return self.type = "captain";
      }), nil) && 'initialize'
    })($scope.base, $scope.get('Player'))
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/players/goalkeeper"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$move_without_rotation_to', '$position_to_cover_goal', '$private', '$y_intercept_with_line', '$x', '$coach_defined_position', '$goal_position', '$side', '$position', '$move_to', '$reset_rotation']);
  self.$require("rubygoal/players/average");
  self.$require("rubygoal/field");
  self.$require("rubygoal/util");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $GoalKeeperPlayer(){};
      var self = $GoalKeeperPlayer = $klass($base, $super, 'GoalKeeperPlayer', $GoalKeeperPlayer);

      var def = self.$$proto, $scope = self.$$scope;

      Opal.defn(self, '$move_to_cover_goal', function(ball) {
        var self = this;

        return self.$move_without_rotation_to(self.$position_to_cover_goal(ball));
      });

      self.$private();

      Opal.defn(self, '$position_to_cover_goal', function(ball) {
        var self = this;

        return $scope.get('Util').$y_intercept_with_line(self.$coach_defined_position().$x(), $scope.get('Field').$goal_position(self.$side()), ball.$position());
      });

      return (Opal.defn(self, '$move_without_rotation_to', function(pos) {
        var self = this;

        self.$move_to(pos);
        return self.$reset_rotation();
      }), nil) && 'move_without_rotation_to';
    })($scope.base, $scope.get('AveragePlayer'))
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/match_data"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  ...
  Opal.add_stubs(['$extend', '$def_delegators', '$new', '$my_score', '$other_score', '$ball_match_position', '$my_positions', '$other_positions', '$time', '$private', '$attr_reader', '$tap', '$delete', '$remove_goalkeeper_position', '$home_players_positions', '$game', '$away_players_positions', '$==', '$side', '$send', '$other_side', '$field_position', '$ball_position', '$position_to_percentages', '$ball_field_position', '$convert_positions_to_percentages', '$result', '$each_with_object', '$[]=', '$positions', '$>', '$<']);
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      (function($base, $super) {
        ...
        self.$def_delegators("game", "ball_position", "score_home", "score_away", "time", "home_players_positions", "away_players_positions");

        Opal.defn(self, '$initialize', function(game, side) {
          var self = this;
        ...
        Opal.defn(self, '$create', function() {
          ...
          return $scope.get('MatchData').$new(self.$my_score(), self.$other_score(), self.$ball_match_position(), self.$my_positions(), self.$other_positions(), self.$time());
        });

        self.$private();

        self.$attr_reader("game", "side");

        Opal.defn(self, '$remove_goalkeeper_position', function(positions) {
          var $a, $b, TMP_1, self = this;

          return ($a = ($b = positions).$tap, $a.$$p = (TMP_1 = function(ps){var self = TMP_1.$$s || this;
if (ps == null) ps = nil;
          return ps.$delete("goalkeeper")}, TMP_1.$$s = self, TMP_1), $a).call($b);
        });

        Opal.defn(self, '$home_players_positions', function() {
          var self = this;

          return self.$remove_goalkeeper_position(self.$game().$home_players_positions());
        });

        Opal.defn(self, '$away_players_positions', function() {
          var self = this;

          return self.$remove_goalkeeper_position(self.$game().$away_players_positions());
        });

        Opal.defn(self, '$other_side', function() {
          var self = this;
        ...
        Opal.defn(self, '$my_score', function() {
          var self = this;

          return self.$send("score_" + (self.$side()));
        });

        Opal.defn(self, '$other_score', function() {
          var self = this;

          return self.$send("score_" + (self.$other_side()));
        });

        Opal.defn(self, '$my_positions', function() {
          var self = this;

          return self.$send("" + (self.$side()) + "_players_positions");
        });

        Opal.defn(self, '$other_positions', function() {
          var self = this;

          return self.$send("" + (self.$other_side()) + "_players_positions");
        });

        Opal.defn(self, '$ball_field_position', function() {
          var self = this;

          return $scope.get('Field').$field_position(self.$ball_position(), self.$side());
        });

        return (Opal.defn(self, '$ball_match_position', function() {
          var self = this;

          return $scope.get('Field').$position_to_percentages(self.$ball_field_position());
        }), nil) && 'ball_match_position';
      })($scope.base, null);

      (function($base, $super) {
        function $Team(){};
        var self = $Team = $klass($base, $super, 'Team', $Team);

        var def = self.$$proto, $scope = self.$$scope;

        self.$attr_reader("score", "result", "positions");

        Opal.defn(self, '$initialize', function(score, result, positions) {
          var self = this;
          ...
          return self.$convert_positions_to_percentages();
        });
        ...
        Opal.defn(self, '$losing?', function() {
          var self = this;
        ...
        return (Opal.defn(self, '$convert_positions_to_percentages', function() {
          var $a, $b, TMP_2, self = this;

          return self.positions = ($a = ($b = self.$positions()).$each_with_object, $a.$$p = (TMP_2 = function($c, hash){var self = TMP_2.$$s || this;
var name = $c[0], pos = $c[1];if (hash == null) hash = nil;
          return hash['$[]='](name, $scope.get('Field').$position_to_percentages(pos))}, TMP_2.$$s = self, TMP_2), $a).call($b, $hash2([], {}));
        }), nil) && 'convert_positions_to_percentages';
      })($scope.base, null);

      self.$attr_reader("me", "other", "time", "ball");

      Opal.defn(self, '$initialize', function(my_score, other_score, ball_position, my_positions, other_positions, time) {
        var self = this;

        self.me = (($scope.get('MatchData')).$$scope.get('Team')).$new(my_score, self.$result(my_score, other_score), my_positions);
        self.other = (($scope.get('MatchData')).$$scope.get('Team')).$new(other_score, self.$result(other_score, my_score), other_positions);
        self.time = time;
        return self.ball = ball_position;
      });

      return (Opal.defn(self, '$result', function(my_score, other_score) {
        var $a, self = this;

        if ((($a = $rb_gt(my_score, other_score)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return "win"
        } else if ((($a = $rb_lt(my_score, other_score)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return "lose"
          } else {
          return "draw"
        };
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/team"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$attr_accessor', '$extend', '$def_delegators', '$new', '$side', '$initialize_lineup_values', '$initialize_players', '$initialize_formation', '$create', '$match_data_factory', '$formation', '$coach', '$restart_player_positions_in_own_field', '$formation=', '$valid?', '$puts', '$errors', '$raise', '$name', '$update_coach_defined_positions', '$each', '$can_kick?', '$ball', '$pass_or_shoot', '$distance', '$position', '$>', '$players_list', '$move_to', '$==', '$!=', '$move_to_cover_goal', '$update', '$move_to_coach_position', '$players', '$values', '$each_with_object', '$[]=', '$field_position', '$private', '$attr_writer', '$initial_formation', '$game', '$captain_player', '$players_by_type', '$initialize_player_positions', '$shoot_target', '$close_to_goal?', '$opponent_side', '$nearest_forward_teammate', '$kick', '$teammate_is_on_front?', '$-', '$/', '$*', '$to_f', '$goal_position', '$y=', '$+', '$y', '$each_with_index', '$position=', '$lineup_to_position', '$[]', '$coach_defined_position=', '$default_player_field_positions', '$players_position', '$x=', '$x', '$absolute_position']);
  self.$require("forwardable");
  self.$require("rubygoal/formation");
  self.$require("rubygoal/field");
  self.$require("rubygoal/players/average");
  self.$require("rubygoal/players/fast");
  self.$require("rubygoal/players/captain");
  self.$require("rubygoal/players/goalkeeper");
  self.$require("rubygoal/match_data");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      def.coach = def.players = nil;
      self.$attr_reader("players", "side", "opponent_side", "coach", "formation");

      self.$attr_accessor("goalkeeper");

      Opal.cdecl($scope, 'INFINITE', 100000);

      self.$extend($scope.get('Forwardable'));

      self.$def_delegators("coach", "name");

      self.$def_delegators("game", "ball");

      Opal.defn(self, '$initialize', function(game, coach) {
        var self = this;

        self.game = game;
        self.players = $hash2([], {});
        self.coach = coach;
        self.match_data_factory = (($scope.get('MatchData')).$$scope.get('Factory')).$new(game, self.$side());
        self.$initialize_lineup_values();
        self.$initialize_players();
        return self.$initialize_formation();
      });

      Opal.defn(self, '$players_to_initial_position', function() {
        var self = this, match_data = nil, formation = nil;

        match_data = self.$match_data_factory().$create();
        formation = self.$coach().$formation(match_data);
        return self.$restart_player_positions_in_own_field(formation);
      });

      Opal.defn(self, '$update', function(elapsed_time) {
        var $a, $b, TMP_1, $c, TMP_2, self = this, match_data = nil, player_to_move = nil, min_distance_to_ball = nil;

        match_data = self.$match_data_factory().$create();
        (($a = [self.$coach().$formation(match_data)]), $b = self, $b['$formation='].apply($b, $a), $a[$a.length-1]);
        if ((($a = self.$formation()['$valid?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$puts(self.$formation().$errors());
          self.$raise("Invalid formation: " + (self.$coach().$name()));
        };
        self.$update_coach_defined_positions(self.$formation());
        player_to_move = nil;
        min_distance_to_ball = $scope.get('INFINITE');
        ($a = ($b = self.$players_list()).$each, $a.$$p = (TMP_1 = function(player){var self = TMP_1.$$s || this, $a, distance_to_ball = nil;
if (player == null) player = nil;
        if ((($a = player['$can_kick?'](self.$ball())) !== nil && (!$a.$$is_boolean || $a == true))) {
            self.$pass_or_shoot(player)};
          distance_to_ball = player.$distance(self.$ball().$position());
          if ((($a = $rb_gt(min_distance_to_ball, distance_to_ball)) !== nil && (!$a.$$is_boolean || $a == true))) {
            min_distance_to_ball = distance_to_ball;
            return player_to_move = player;
            } else {
            return nil
          };}, TMP_1.$$s = self, TMP_1), $a).call($b);
        player_to_move.$move_to(self.$ball().$position());
        return ($a = ($c = self.$players()).$each, $a.$$p = (TMP_2 = function(name, player){var self = TMP_2.$$s || this, $a;
if (name == null) name = nil;if (player == null) player = nil;
        if (name['$==']("goalkeeper")) {
            if ((($a = player['$!='](player_to_move)) !== nil && (!$a.$$is_boolean || $a == true))) {
              player.$move_to_cover_goal(self.$ball());
              player.$update(elapsed_time);
              return nil;;}};
          if (player['$=='](player_to_move)) {
            } else {
            player.$move_to_coach_position()
          };
          return player.$update(elapsed_time);}, TMP_2.$$s = self, TMP_2), $a).call($c);
      });

      Opal.defn(self, '$players_list', function() {
        var self = this;

        return self.$players().$values();
      });

      Opal.defn(self, '$players_position', function() {
        var $a, $b, TMP_3, self = this;

        return ($a = ($b = self.$players()).$each_with_object, $a.$$p = (TMP_3 = function($c, hash){var self = TMP_3.$$s || this;
var name = $c[0], player = $c[1];if (hash == null) hash = nil;
        return hash['$[]='](name, $scope.get('Field').$field_position(player.$position(), self.$side()))}, TMP_3.$$s = self, TMP_3), $a).call($b, $hash2([], {}));
      });

      self.$private();

      self.$attr_reader("game", "match_data_factory");

      self.$attr_writer("formation");

      Opal.defn(self, '$initialize_lineup_values', function() {
        var self = this;

        self.average_players_count = 6;
        return self.fast_players_count = 3;
      });

      Opal.defn(self, '$initialize_formation', function() {
        var self = this;

        return self.formation = self.coach.$initial_formation();
      });

      Opal.defn(self, '$initialize_players', function() {
        var $a, $b, TMP_4, $c, TMP_5, self = this;

        self.players = $hash2(["goalkeeper"], {"goalkeeper": $scope.get('GoalKeeperPlayer').$new(self.$game(), self.$side())});
        if ((($a = self.coach['$valid?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$puts(self.coach.$errors());
          self.$raise("Invalid team definition: " + (self.coach.$name()));
        };
        self.players['$[]='](self.coach.$captain_player().$name(), $scope.get('CaptainPlayer').$new(self.$game(), self.$side()));
        ($a = ($b = self.coach.$players_by_type("fast")).$each, $a.$$p = (TMP_4 = function(player_def){var self = TMP_4.$$s || this;
          if (self.players == null) self.players = nil;
if (player_def == null) player_def = nil;
        return self.players['$[]='](player_def.$name(), $scope.get('FastPlayer').$new(self.$game(), self.$side()))}, TMP_4.$$s = self, TMP_4), $a).call($b);
        ($a = ($c = self.coach.$players_by_type("average")).$each, $a.$$p = (TMP_5 = function(player_def){var self = TMP_5.$$s || this;
          if (self.players == null) self.players = nil;
if (player_def == null) player_def = nil;
        return self.players['$[]='](player_def.$name(), $scope.get('AveragePlayer').$new(self.$game(), self.$side()))}, TMP_5.$$s = self, TMP_5), $a).call($c);
        return self.$initialize_player_positions();
      });

      Opal.defn(self, '$pass_or_shoot', function(player) {
        var $a, self = this, target = nil, teammate = nil;

        target = self.$shoot_target();
        if ((($a = $scope.get('Field')['$close_to_goal?'](player.$position(), self.$opponent_side())) !== nil && (!$a.$$is_boolean || $a == true))) {
        } else if ((($a = teammate = self.$nearest_forward_teammate(player)) !== nil && (!$a.$$is_boolean || $a == true))) {
          target = teammate.$position()};
        return player.$kick(self.$ball(), target);
      });

      Opal.defn(self, '$nearest_forward_teammate', function(player) {
        var $a, $b, TMP_6, self = this, min_dist = nil, nearest_teammate = nil;

        min_dist = $scope.get('INFINITE');
        nearest_teammate = nil;
        ($a = ($b = ($rb_minus(self.$players().$values(), [player]))).$each, $a.$$p = (TMP_6 = function(teammate){var self = TMP_6.$$s || this, $a, dist = nil;
if (teammate == null) teammate = nil;
        if ((($a = self['$teammate_is_on_front?'](player, teammate)) !== nil && (!$a.$$is_boolean || $a == true))) {
            dist = player.$distance(teammate.$position());
            if ((($a = $rb_gt(min_dist, dist)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$shoot_target', function() {
        var $a, self = this, limit = nil, offset = nil, target = nil;

        limit = $rb_divide((($scope.get('Field')).$$scope.get('GOAL_HEIGHT')), 2);
        offset = $rb_minus($rb_times($rb_times((Math.random()).$to_f(), 2), limit), limit);
        target = $scope.get('Field').$goal_position(self.$opponent_side());
        ($a = target, $a['$y=']($rb_plus($a.$y(), offset)));
        return target;
      });

      Opal.defn(self, '$initialize_player_positions', function() {
        var $a, $b, TMP_7, self = this;

        return ($a = ($b = $scope.get('Field').$default_player_field_positions()).$each_with_index, $a.$$p = (TMP_7 = function(pos, index){var self = TMP_7.$$s || this, $a, $b;
if (pos == null) pos = nil;if (index == null) index = nil;
        (($a = [self.$lineup_to_position(pos)]), $b = self.$players().$values()['$[]'](index), $b['$position='].apply($b, $a), $a[$a.length-1]);
          return (($a = [self.$lineup_to_position(pos)]), $b = self.$players().$values()['$[]'](index), $b['$coach_defined_position='].apply($b, $a), $a[$a.length-1]);}, TMP_7.$$s = self, TMP_7), $a).call($b);
      });

      Opal.defn(self, '$update_coach_defined_positions', function(formation) {
        var $a, $b, TMP_8, self = this;

        return ($a = ($b = formation.$players_position()).$each, $a.$$p = (TMP_8 = function(player_name, pos){var self = TMP_8.$$s || this, $a, $b;
if (player_name == null) player_name = nil;if (pos == null) pos = nil;
        return (($a = [self.$lineup_to_position(pos)]), $b = self.$players()['$[]'](player_name), $b['$coach_defined_position='].apply($b, $a), $a[$a.length-1])}, TMP_8.$$s = self, TMP_8), $a).call($b);
      });

      Opal.defn(self, '$restart_player_positions_in_own_field', function(formation) {
        var $a, $b, TMP_9, self = this;

        return ($a = ($b = formation.$players_position()).$each, $a.$$p = (TMP_9 = function(player_name, pos){var self = TMP_9.$$s || this, $a, $b, player = nil;
if (player_name == null) player_name = nil;if (pos == null) pos = nil;
        ($a = pos, $a['$x=']($rb_times($a.$x(), 0.5)));
          pos = self.$lineup_to_position(pos);
          player = self.$players()['$[]'](player_name);
          (($a = [pos]), $b = player, $b['$coach_defined_position='].apply($b, $a), $a[$a.length-1]);
          return (($a = [pos]), $b = player, $b['$position='].apply($b, $a), $a[$a.length-1]);}, TMP_9.$$s = self, TMP_9), $a).call($b);
      });

      Opal.defn(self, '$lineup_to_position', function(field_position) {
        var self = this;

        return $scope.get('Field').$absolute_position(field_position, self.$side());
      });

      return (Opal.defn(self, '$goalkeeper', function() {
        var self = this;

        return self.$players()['$[]']("goalkeeper");
      }), nil) && 'goalkeeper';
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/teams/home"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  ...
  Opal.add_stubs(['$require', '$>', '$x', '$position', '$+']);
  self.$require("rubygoal/team");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $HomeTeam(){};
      var self = $HomeTeam = $klass($base, $super, 'HomeTeam', $HomeTeam);

      var def = self.$$proto, $scope = self.$$scope, TMP_1;

      Opal.defn(self, '$initialize', TMP_1 = function() {
        var self = this, $iter = TMP_1.$$p, $yield = $iter || nil, $splat_index = nil, $zuper = nil, $zuper_index = nil;
        ...
        self.side = "home";
        self.opponent_side = "away";
        return Opal.find_super_dispatcher(self, 'initialize', TMP_1, $iter).apply(self, $zuper);
      });

      return (Opal.defn(self, '$teammate_is_on_front?', function(player, teammate) {
        var self = this;

        return $rb_gt(teammate.$position().$x(), $rb_plus(player.$position().$x(), 40));
      }), nil) && 'teammate_is_on_front?';
    })($scope.base, $scope.get('Team'))
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/teams/away"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $AwayTeam(){};
      var self = $AwayTeam = $klass($base, $super, 'AwayTeam', $AwayTeam);
      ...
      return (Opal.defn(self, '$teammate_is_on_front?', function(player, teammate) {
        ...
        return $rb_lt(teammate.$position().$x(), $rb_minus(player.$position().$x(), 40));
      }), nil) && 'teammate_is_on_front?';
    })($scope.base, $scope.get('Team'))
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/field"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_divide(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs / rhs : lhs['$/'](rhs);
  ...
  Opal.add_stubs(['$require', '$new', '$/', '$add', '$center_position', '$===', '$x=', '$x', '$+', '$-', '$y', '$-@', '$*', '$<', '$!', '$include?', '$out_of_bounds_width?', '$goal_position', '$distance']);
  self.$require("forwardable");
  self.$require("rubygoal/ball");
  self.$require("rubygoal/coach_loader");
  self.$require("rubygoal/teams/home");
  self.$require("rubygoal/teams/away");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base) {
      var $Field, self = $Field = $module($base, 'Field');

      var def = self.$$proto, $scope = self.$$scope;

      Opal.cdecl($scope, 'WIDTH', 1394.0);

      Opal.cdecl($scope, 'HEIGHT', 938.0);

      Opal.cdecl($scope, 'OFFSET', $scope.get('Position').$new(262, 112));

      Opal.cdecl($scope, 'GOAL_HEIGHT', 275);

      Opal.cdecl($scope, 'CLOSE_GOAL_DISTANCE', 275);

      (function(self) {
        var $scope = self.$$scope, def = self.$$proto;

        Opal.defn(self, '$center_position', function() {
          var self = this, center = nil;

          center = $scope.get('Position').$new($rb_divide($scope.get('WIDTH'), 2), $rb_divide($scope.get('HEIGHT'), 2));
          return $scope.get('OFFSET').$add(center);
        });
        Opal.defn(self, '$goal_position', function(side) {
          var $a, $b, self = this, position = nil, $case = nil;

          position = self.$center_position();
          $case = side;if ("home"['$===']($case)) {(($a = [$scope.get('OFFSET').$x()]), $b = position, $b['$x='].apply($b, $a), $a[$a.length-1])}else if ("away"['$===']($case)) {(($a = [$rb_plus($scope.get('OFFSET').$x(), $scope.get('WIDTH'))]), $b = position, $b['$x='].apply($b, $a), $a[$a.length-1])};
          return position;
        });
        Opal.defn(self, '$absolute_position', function(field_position, side) {
          var self = this, $case = nil;

          return (function() {$case = side;if ("home"['$===']($case)) {return $scope.get('OFFSET').$add(field_position)}else if ("away"['$===']($case)) {return $scope.get('OFFSET').$add($scope.get('Position').$new($rb_minus($scope.get('WIDTH'), field_position.$x()), $rb_minus($scope.get('HEIGHT'), field_position.$y())))}else { return nil }})();
        });
        Opal.defn(self, '$field_position', function(absolute_position, side) {
          var self = this, $case = nil;

          return (function() {$case = side;if ("home"['$===']($case)) {return absolute_position.$add($scope.get('Position').$new($scope.get('OFFSET').$x()['$-@'](), $scope.get('OFFSET').$y()['$-@']()))}else if ("away"['$===']($case)) {return $scope.get('Position').$new($rb_minus($scope.get('WIDTH'), ($rb_minus(absolute_position.$x(), $scope.get('OFFSET').$x()))), $rb_minus($scope.get('HEIGHT'), ($rb_minus(absolute_position.$y(), $scope.get('OFFSET').$y()))))}else { return nil }})();
        });
        Opal.defn(self, '$position_from_percentages', function(position_in_percentages) {
          var self = this;

          return $scope.get('Position').$new($rb_times($rb_divide(position_in_percentages.$x(), 100.0), (($scope.get('Field')).$$scope.get('WIDTH'))), $rb_times($rb_divide(position_in_percentages.$y(), 100.0), (($scope.get('Field')).$$scope.get('HEIGHT'))));
        });
        Opal.defn(self, '$position_to_percentages', function(position) {
          var self = this;

          return $scope.get('Position').$new($rb_times($rb_divide(position.$x(), (($scope.get('Field')).$$scope.get('WIDTH'))), 100), $rb_times($rb_divide(position.$y(), (($scope.get('Field')).$$scope.get('HEIGHT'))), 100));
        });
        Opal.defn(self, '$position_side', function(position) {
          var $a, self = this;

          if ((($a = $rb_lt(position.$x(), self.$center_position().$x())) !== nil && (!$a.$$is_boolean || $a == true))) {
            return "home"
            } else {
            return "away"
          };
        });
        Opal.defn(self, '$out_of_bounds_width?', function(position) {
          var self = this, lower_limit = nil, upper_limit = nil;

          lower_limit = $scope.get('OFFSET').$x();
          upper_limit = $rb_plus($scope.get('OFFSET').$x(), $scope.get('WIDTH'));
          return ($range(lower_limit, upper_limit, false))['$include?'](position.$x())['$!']();
        });
        Opal.defn(self, '$out_of_bounds_height?', function(position) {
          var self = this, lower_limit = nil, upper_limit = nil;

          lower_limit = $scope.get('OFFSET').$y();
          upper_limit = $rb_plus($scope.get('OFFSET').$y(), $scope.get('HEIGHT'));
          return ($range(lower_limit, upper_limit, false))['$include?'](position.$y())['$!']();
        });
        Opal.defn(self, '$goal?', function(position) {
          var $a, self = this, lower_limit = nil, upper_limit = nil;

          if ((($a = self['$out_of_bounds_width?'](position)) !== nil && (!$a.$$is_boolean || $a == true))) {
            lower_limit = $rb_minus(self.$center_position().$y(), $rb_divide($scope.get('GOAL_HEIGHT'), 2));
            upper_limit = $rb_plus(self.$center_position().$y(), $rb_divide($scope.get('GOAL_HEIGHT'), 2));
            return ($range(lower_limit, upper_limit, false))['$include?'](position.$y());
            } else {
            return false
          };
        });
        Opal.defn(self, '$close_to_goal?', function(position, side) {
          var self = this, goal_position = nil;

          goal_position = $scope.get('Field').$goal_position(side);
          return $rb_lt(goal_position.$distance(position), $scope.get('CLOSE_GOAL_DISTANCE'));
        });
        return (Opal.defn(self, '$default_player_field_positions', function() {
          var self = this, defenders = nil, midfielders = nil, attackers = nil;

          defenders = $rb_divide((($scope.get('Field')).$$scope.get('WIDTH')), 6);
          midfielders = $rb_divide((($scope.get('Field')).$$scope.get('WIDTH')), 2);
          attackers = $rb_divide($rb_times((($scope.get('Field')).$$scope.get('WIDTH')), 5), 6);
          return [$scope.get('Position').$new(50, $rb_divide((($scope.get('Field')).$$scope.get('HEIGHT')), 2)), $scope.get('Position').$new(defenders, $rb_divide((($scope.get('Field')).$$scope.get('HEIGHT')), 5)), $scope.get('Position').$new(defenders, $rb_divide($rb_times((($scope.get('Field')).$$scope.get('HEIGHT')), 2), 5)), $scope.get('Position').$new(defenders, $rb_divide($rb_times((($scope.get('Field')).$$scope.get('HEIGHT')), 3), 5)), $scope.get('Position').$new(defenders, $rb_divide($rb_times((($scope.get('Field')).$$scope.get('HEIGHT')), 4), 5)), $scope.get('Position').$new(midfielders, $rb_divide((($scope.get('Field')).$$scope.get('HEIGHT')), 5)), $scope.get('Position').$new(midfielders, $rb_divide($rb_times((($scope.get('Field')).$$scope.get('HEIGHT')), 2), 5)), $scope.get('Position').$new(midfielders, $rb_divide($rb_times((($scope.get('Field')).$$scope.get('HEIGHT')), 3), 5)), $scope.get('Position').$new(midfielders, $rb_divide($rb_times((($scope.get('Field')).$$scope.get('HEIGHT')), 4), 5)), $scope.get('Position').$new(attackers, $rb_divide((($scope.get('Field')).$$scope.get('HEIGHT')), 3)), $scope.get('Position').$new(attackers, $rb_divide($rb_times((($scope.get('Field')).$$scope.get('HEIGHT')), 2), 3))];
        }), nil) && 'default_player_field_positions';
      })(Opal.get_singleton_class(self));
    })($scope.base)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/goal"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  ...
  Opal.add_stubs(['$require', '$>', '$celebration_time', '$celebration_time=', '$celebrating?', '$start_celebration', '$-', '$protected', '$attr_accessor']);
  self.$require("rubygoal/configuration");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $Goal(){};
      var self = $Goal = $klass($base, $super, 'Goal', $Goal);
      ...
      Opal.defn(self, '$initialize', function() {
        ...
        return self.celebration_time = 0;
      });

      Opal.defn(self, '$celebrating?', function() {
        var self = this;

        return $rb_gt(self.$celebration_time(), 0);
      });

      Opal.defn(self, '$start_celebration', function() {
        var $a, $b, self = this;

        return (($a = [3]), $b = self, $b['$celebration_time='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$update', function(elapsed_time) {
        var $a, self = this;

        if ((($a = self['$celebrating?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$start_celebration()
        };
        return ($a = self, $a['$celebration_time=']($rb_minus($a.$celebration_time(), elapsed_time)));
      });

      self.$protected();

      return self.$attr_accessor("celebration_time");
    })($scope.base, null)
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/recorder"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$<<', '$frame_info', '$name', '$coach_home', '$coach_away', '$score_home', '$score_away', '$private', '$attr_reader', '$round', '$time', '$x', '$position', '$ball', '$y', '$team_info', '$team_home', '$team_away', '$map', '$rotation', '$type', '$players']);
  self.$require("rubygoal/game");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      def.frames = def.game = nil;
      Opal.defn(self, '$initialize', function(game) {
        var self = this;
      ...
      Opal.defn(self, '$update', function() {
        ...
        return self.frames['$<<'](self.$frame_info());
      });

      Opal.defn(self, '$to_hash', function() {
        var self = this;

        return $hash2(["teams", "score", "frames"], {"teams": $hash2(["home", "away"], {"home": self.game.$coach_home().$name(), "away": self.game.$coach_away().$name()}), "score": $hash2(["home", "away"], {"home": self.game.$score_home(), "away": self.game.$score_away()}), "frames": self.frames});
      });

      self.$private();

      self.$attr_reader("game", "frames");

      Opal.defn(self, '$frame_info', function() {
        var self = this;

        return $hash2(["time", "score", "ball", "home_players", "away_players"], {"time": self.game.$time().$round(0), "score": $hash2(["home", "away"], {"home": self.game.$score_home(), "away": self.game.$score_away()}), "ball": $hash2(["x", "y"], {"x": self.game.$ball().$position().$x().$round(0), "y": self.game.$ball().$position().$y().$round(0)}), "home_players": self.$team_info(self.game.$team_home()), "away_players": self.$team_info(self.game.$team_away())});
      });

      return (Opal.defn(self, '$team_info', function(team) {
        var $a, $b, TMP_1, self = this;

        return ($a = ($b = team.$players()).$map, $a.$$p = (TMP_1 = function(_, player){var self = TMP_1.$$s || this;
if (_ == null) _ = nil;if (player == null) player = nil;
        return $hash2(["x", "y", "angle", "type"], {"x": player.$position().$x().$round(0), "y": player.$position().$y().$round(0), "angle": player.$rotation().$round(0), "type": player.$type()})}, TMP_1.$$s = self, TMP_1), $a).call($b);
      }), nil) && 'team_info';
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["rubygoal/game"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_le(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs <= rhs : lhs['$<='](rhs);
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$debug_output?', '$puts', '$name', '$record_game?', '$new', '$game_time', '$configuration', '$reinitialize_players', '$elapsed_time=', '$ended?', '$celebrating_goal?', '$update_goal', '$update_remaining_time', '$update', '$team_home', '$team_away', '$update_ball', '$recorder', '$<=', '$time', '$end_match!', '$now', '$flatten', '$map', '$to_proc', '$teams', '$celebrating?', '$goal', '$players_position', '$position', '$ball', '$to_hash', '$==', '$state', '$coach_home', '$coach_away', '$protected', '$attr_writer', '$attr_accessor', '$private', '$time=', '$-', '$elapsed_time', '$goal?', '$update_score', '$start_celebration', '$reinitialize_match', '$reinitialize_ball', '$position_side', '$ball_position', '$score_away=', '$+', '$score_away', '$score_home=', '$score_home', '$each', '$position=', '$center_position', '$state=', '$puts_score', '$debug_output', '$record_game']);
  self.$require("forwardable");
  self.$require("rubygoal/coordinate");
  self.$require("rubygoal/field");
  self.$require("rubygoal/goal");
  self.$require("rubygoal/recorder");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      ...
      def.coach_home = def.coach_away = nil;
      self.$attr_reader("team_home", "team_away", "ball", "time", "goal", "recorder", "coach_home", "coach_away", "score_home", "score_away");

      Opal.defn(self, '$initialize', function(coach_home, coach_away) {
        var $a, self = this;

        self.coach_home = coach_home;
        self.coach_away = coach_away;
        if ((($a = self['$debug_output?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$puts("Home coach: " + (self.coach_home.$name()));
          self.$puts("Away coach: " + (self.coach_away.$name()));};
        if ((($a = self['$record_game?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.recorder = $scope.get('Recorder').$new(self)};
        self.ball = $scope.get('Ball').$new();
        self.team_home = $scope.get('HomeTeam').$new(self, coach_home);
        self.team_away = $scope.get('AwayTeam').$new(self, coach_away);
        self.goal = $scope.get('Goal').$new();
        self.state = "playing";
        self.time = $scope.get('Rubygoal').$configuration().$game_time();
        self.score_home = 0;
        self.score_away = 0;
        return self.$reinitialize_players();
      });
      ...
      Opal.defn(self, '$update', function(elapsed_time) {
        ...
        if (elapsed_time == null) {
          elapsed_time = $scope.get('Time').$now()
        }
        (($a = [elapsed_time]), $b = self, $b['$elapsed_time='].apply($b, $a), $a[$a.length-1]);
        if ((($a = self['$ended?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        if ((($a = self['$celebrating_goal?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$update_goal()
          } else {
          self.$update_remaining_time();
          self.$team_home().$update(elapsed_time);
          self.$team_away().$update(elapsed_time);
          self.$update_ball();
        };
        if ((($a = self['$record_game?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$recorder().$update()};
        if ((($a = $rb_le(self.$time(), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$players', function() {
        ...
        return ($a = ($b = self.$teams()).$map, $a.$$p = "players_list".$to_proc(), $a).call($b).$flatten();
      });

      Opal.defn(self, '$celebrating_goal?', function() {
        var self = this;

        return self.$goal()['$celebrating?']();
      });

      Opal.defn(self, '$home_players_positions', function() {
        var self = this;

        return self.$team_home().$players_position();
      });

      Opal.defn(self, '$away_players_positions', function() {
        var self = this;

        return self.$team_away().$players_position();
      });

      Opal.defn(self, '$ball_position', function() {
        var self = this;

        return self.$ball().$position();
      });

      Opal.defn(self, '$recorded_game', function() {
        var $a, self = this;

        if ((($a = self['$record_game?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.$recorder().$to_hash()
          } else {
          return nil
        };
      });

      Opal.defn(self, '$ended?', function() {
        var self = this;

        return self.$state()['$==']("ended");
      });

      Opal.defn(self, '$team_names', function() {
        var self = this;

        return [self.$coach_home().$name(), self.$coach_away().$name()];
      });

      self.$protected();

      self.$attr_writer("time", "score_home", "score_away");

      self.$attr_accessor("state", "last_time", "elapsed_time");

      self.$private();

      Opal.defn(self, '$update_remaining_time', function() {
        var $a, self = this;

        return ($a = self, $a['$time=']($rb_minus($a.$time(), self.$elapsed_time())));
      });

      Opal.defn(self, '$update_ball', function() {
        var $a, self = this;

        self.$ball().$update(self.$elapsed_time());
        if ((($a = self.$ball()['$goal?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$update_score();
          return self.$goal().$start_celebration();
          } else {
          return nil
        };
      });

      Opal.defn(self, '$update_goal', function() {
        var $a, self = this;

        self.$goal().$update(self.$elapsed_time());
        if ((($a = self.$goal()['$celebrating?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil
          } else {
          return self.$reinitialize_match()
        };
      });

      Opal.defn(self, '$reinitialize_match', function() {
        var self = this;

        self.$reinitialize_players();
        return self.$reinitialize_ball();
      });

      Opal.defn(self, '$update_score', function() {
        var $a, self = this;

        if ($scope.get('Field').$position_side(self.$ball_position())['$==']("home")) {
          return ($a = self, $a['$score_away=']($rb_plus($a.$score_away(), 1)))
          } else {
          return ($a = self, $a['$score_home=']($rb_plus($a.$score_home(), 1)))
        };
      });

      Opal.defn(self, '$reinitialize_players', function() {
        var $a, $b, self = this;

        return ($a = ($b = self.$teams()).$each, $a.$$p = "players_to_initial_position".$to_proc(), $a).call($b);
      });

      Opal.defn(self, '$reinitialize_ball', function() {
        var $a, $b, self = this;

        return (($a = [$scope.get('Field').$center_position()]), $b = self.$ball(), $b['$position='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$teams', function() {
        var self = this;

        return [self.$team_home(), self.$team_away()];
      });

      Opal.defn(self, '$end_match!', function() {
        var $a, $b, self = this;

        (($a = ["ended"]), $b = self, $b['$state='].apply($b, $a), $a[$a.length-1]);
        if ((($a = self['$debug_output?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.$puts_score()
          } else {
          return nil
        };
      });

      Opal.defn(self, '$puts_score', function() {
        var self = this;

        return self.$puts("" + (self.$coach_home().$name()) + " " + (self.$score_home()) + " - " + (self.$score_away()) + " " + (self.$coach_away().$name()));
      });

      Opal.defn(self, '$debug_output?', function() {
        var self = this;

        return $scope.get('Rubygoal').$configuration().$debug_output();
      });

      return (Opal.defn(self, '$record_game?', function() {
        var self = this;

        return $scope.get('Rubygoal').$configuration().$record_game();
      }), nil) && 'record_game?';
    })($scope.base, null)
  })($scope.base);
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$extend', '$def_delegators', '$record_game=', '$configuration', '$new', '$load_coach', '$/', '$!', '$ended?', '$game', '$update', '$private', '$attr_reader', '$coach']);
  self.$require("rubygoal/game");
  return (function($base) {
    var $Rubygoal, self = $Rubygoal = $module($base, 'Rubygoal');
    ...
    (function($base, $super) {
      function $Simulator(){};
      var self = $Simulator = $klass($base, $super, 'Simulator', $Simulator);

      var def = self.$$proto, $scope = self.$$scope;

      self.$extend($scope.get('Forwardable'));

      self.$def_delegators("game", "recorded_game", "team_names");

      Opal.defn(self, '$initialize', function() {
        var $a, $b, self = this;

        (($a = [true]), $b = $scope.get('Rubygoal').$configuration(), $b['$record_game='].apply($b, $a), $a[$a.length-1]);
        return self.game = (($scope.get('Rubygoal')).$$scope.get('Game')).$new(self.$load_coach("home"), self.$load_coach("away"));
      });

      Opal.defn(self, '$simulate', function() {
        var $a, $b, self = this, time = nil;

        time = $rb_divide(1.0, 20.0);
        while ((($b = self.$game()['$ended?']()['$!']()) !== nil && (!$b.$$is_boolean || $b == true))) {
      ...
      return (Opal.defn(self, '$load_coach', function(side) {
        var self = this;

        return $scope.get('CoachLoader').$new(side).$coach();
      }), nil) && 'load_coach';
    })($scope.base, null)
  })($scope.base);
})(Opal);
