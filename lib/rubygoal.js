...
Opal.modules["rubygoal/coaches/coach_definition_home"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$team', '$name', '$js_coach', '$players', '$each', '$to_sym', '$===', '$captain', '$fast', '$average', '$class', '$winning?', '$me', '$losing?', '$draw?', '$other', '$x', '$ball', '$y', '$new', '$defenders', '$map', '$to_proc', '$midfielders', '$attackers']);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defs(self, '$js_coach', function() {
        var self = this;
      ...
      self.$name(self.$js_coach()["name"]);
        return ($a = ($b = self).$players, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $a, $b, TMP_3;

        return ($a = ($b = self.$js_coach()["players"]).$each, $a.$$p = (TMP_3 = function(player){var self = TMP_3.$$s || this, player_name = nil, $case = nil;
if (player == null) player = nil;
          player_name = player["name"].$to_sym();
            return (function() {$case = player["type"];if ("captain"['$===']($case)) {return self.$captain(player_name)}else if ("fast"['$===']($case)) {return self.$fast(player_name)}else if ("average"['$===']($case)) {return self.$average(player_name)}else { return nil }})();}, TMP_3.$$s = self, TMP_3), $a).call($b)}, TMP_2.$$s = self, TMP_2), $a).call($b);}, TMP_1.$$s = self, TMP_1), $a).call($b);

      return (Opal.defn(self, '$formation', function(match) {
        var $a, $b, $c, $d, $e, $f, $g, self = this, result = nil, formation = nil;

        result = self.$class().$js_coach().formation(
          {
            me: {
